...
// but you'll understand closures by the time you finish for sure.
...
let nameBox = document.getElementById("exercise1");  // button
clicker.onclick = function() {
  timesClicked = timesClicked + 1;
  counterBox.innerText = timesClicked;
  nameBox.innerText = names[timesClicked % names.length];
};
