...
let favoriteAnimal = "Blue Whale";
let favoriteAnimalLength = 29;
...
// console.log line.
favoriteAnimal = "Pigeon";
favoriteAnimalLength = 1;
myVariable = 1334;
anotherVariable = 101;
name = "Daniel";
greeting = "Hello! My name is " + name + " and it's nice to meet you!";
...
anotherVariable = 34;
anotherVariable = anotherVariable * anotherVariable;
